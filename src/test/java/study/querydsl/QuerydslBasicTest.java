...
public class QuerydslBasicTest {
    ...
    public void startQuerydsl() {
         ...
         // 테이블을 조인할 때 이렇게 쓰는게 좋다. log에 alias로 출력되기 때문.
         QMember m = member;
...
//                .fetchFirst();
    ...
    * */
    ...
    public void aggregation() {
        ...
        // 튜플로 리턴하고, DTO로 뽑아오는 방법이 있는데 DTO로 뽑아오는 방법으로 많이 씀.
...
//                .having()
    ...
    * JPQL : select m, t from Member m left join Team t ont.name = 'teamA'
    * 
    * */
    @Test
    ...
    public void fetchJoinUse() {
        ...
        // Member를 조인할 때 연관돈 팀을 가져오고 하위의 loaded는 false가 된다
        Member findMember = queryFactory
                .selectFrom(member)
    ...
    * */
    ...
    private Predicate allEq(String usernameCond, Integer ageCond) {
        return usernameEq(usernameCond).and(ageCondEq(ageCond));
    }
...
//    @Commit
    ...
    public void sqlFunction() {
        // function은 H2Dialect에 등록되어 있어야함
        List<String> result = queryFactory
